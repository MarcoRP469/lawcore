...
from .routers import auth, usuarios, notarias, comentarios, anuncios, upload, metricas, suscripciones
...
app.include_router(suscripciones.router, prefix="/suscripciones", tags=["suscripciones"])
