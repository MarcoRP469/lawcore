...
import { getServiceImage } from "@/lib/service-icons";
                                            ...
                                            <DialogTrigger asChild>
                                                <Card className="group relative overflow-hidden rounded-lg cursor-pointer transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                                                    <CardContent className="p-0">
                                                        <Image
                                                            src={getServiceImage(service.images, service.category)}
                                                ...
                                                <ScrollArea className="max-h-[60vh] pr-4">
                                                    <div className="py-4 space-y-6">
                                                        ...
                                                        {service.images && service.images.length > 0 && (
                                                            <div>
                                                                <h4 className="font-semibold mb-3">Imágenes del Servicio:</h4>
                                                                <AutoCarousel
